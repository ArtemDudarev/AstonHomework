...
//        transactions.stream().filter(x-> x.getTrader().getCity().equals("Cambridge")).sorted(new Comparator<Transaction>() {
//            @Override
//            public int compare(Transaction o1, Transaction o2) {
//                return o1.getTrader().getName().compareTo(o2.getTrader().getName());
//            }
//        }).map(x-> x.getTrader().getName()).distinct().forEach(System.out::println);
